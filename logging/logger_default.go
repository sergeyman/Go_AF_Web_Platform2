...
Каждому уровню серьезности назначается log.Logger, который
означает, что сообщения могут быть отправлены разным адресатам или отформатированы по-разному.
*/
...
/* the default implementation of the Logger interface Ch.31 */
